...
const translations = {
    en: {
        ...
        messageError: "Message sent successfully!",
    ...
    ar: {
        ...
        product2: "زجاجيات",
        product2Desc: "زجاجيات معمليه ذات جوده ممتازه.",
        product3: "ميديا معامل",
        product3Desc: "مجموعة من وسائط الزراعة والمكملات الغذائية.",
        productButton: "شاهد المنتجات",
        aboutUs: "من نحن",
        whoWeAre: "من نحن",
        ...
        address: "مدينه السادات، المنوفيه ",
        ...
        catalogTitle: "دليل المنتجات",
        searchPlaceholder: "البحث عن المنتجات...",
        allCategories: "جميع الفئات",
        chemicals: "مواد كيميائية",
        media: "وسائط",
        glassware: "أدوات زجاجية",
        sortOptions: {
            nameAsc: "الاسم (أ-ي)",
            nameDesc: "الاسم (ي-أ)"
        },
...
(function() {
    ...
    function initAnimation() {
        ...
        const PARTICLE_COLORS = {
            light: {
                particle: 'rgba(75, 85, 99,',  // Gray for light mode
                line: 'rgba(75, 85, 99,'      // Gray for connections
            },
            dark: {
                particle: 'rgba(255, 255, 255,',  // White for dark mode
                line: 'rgba(255, 255, 255,'      // White for connections
            }
        };

        function getParticleColors() {
            return document.documentElement.classList.contains('dark') 
                ? PARTICLE_COLORS.dark 
                : PARTICLE_COLORS.light;
        }
...
function sendEmail(e) {
    ...
    emailjs.sendForm('service_e2pre8g', 'template_xpd7n0n', e.target)
        .then((response) => {
...
document.getElementById('contactForm')?.addEventListener('submit', function(e) {
    ...
    .catch((error) => {
        ...
        alert(translations[currentLanguage].messageError || 'Message sent successfully!');
    })
    .finally(() => {
